...
class MLRepository:
    ...
    def _load_resources(self):
        try:
            ...
            print(f"✅ Model & Scaler loaded from {self.model_path} and {self.scaler_path}")
        except Exception as e:
            print(f"❌ Failed to load model/scaler: {e}")
            # In a real production scenario, we might want to raise an exception here
            # For now, we'll let it be and handle it in predict
